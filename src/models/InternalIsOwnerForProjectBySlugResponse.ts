...
export function InternalIsOwnerForProjectBySlugResponseToJSON(json: any): InternalIsOwnerForProjectBySlugResponse {
    return InternalIsOwnerForProjectBySlugResponseToJSONTyped(json, false);
}

export function InternalIsOwnerForProjectBySlugResponseToJSONTyped(value?: InternalIsOwnerForProjectBySlugResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

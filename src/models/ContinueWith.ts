...
import type { ContinueWithDeviceAuthnPinEntryUi } from './ContinueWithDeviceAuthnPinEntryUi';
import {
    instanceOfContinueWithDeviceAuthnPinEntryUi,
    ContinueWithDeviceAuthnPinEntryUiFromJSON,
    ContinueWithDeviceAuthnPinEntryUiFromJSONTyped,
    ContinueWithDeviceAuthnPinEntryUiToJSON,
} from './ContinueWithDeviceAuthnPinEntryUi';
 ...
 * @export
 */
export type ContinueWith = { action: 'redirect_browser_to' } & ContinueWithRedirectBrowserTo | { action: 'set_ory_session_token' } & ContinueWithSetOrySessionToken | { action: 'show_pin_entry_ui' } & ContinueWithDeviceAuthnPinEntryUi | { action: 'show_recovery_ui' } & ContinueWithRecoveryUi | { action: 'show_settings_ui' } & ContinueWithSettingsUi | { action: 'show_verification_ui' } & ContinueWithVerificationUi;
...
export function ContinueWithFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContinueWith {
    ...
    switch (json['action']) {
        ...
        case 'show_pin_entry_ui':
            return Object.assign({}, ContinueWithDeviceAuthnPinEntryUiFromJSONTyped(json, true), { action: 'show_pin_entry_ui' } as const);
...
export function ContinueWithToJSONTyped(value?: ContinueWith | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['action']) {
        ...
        case 'show_pin_entry_ui':
            return Object.assign({}, ContinueWithDeviceAuthnPinEntryUiToJSON(value), { action: 'show_pin_entry_ui' } as const);
        case 'show_recovery_ui':

...
export function CreateWorkspaceBodyToJSON(json: any): CreateWorkspaceBody {
    return CreateWorkspaceBodyToJSONTyped(json, false);
}

export function CreateWorkspaceBodyToJSONTyped(value?: CreateWorkspaceBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

...
import type { UpdateLoginFlowWithDeviceAuthnMethod } from './UpdateLoginFlowWithDeviceAuthnMethod';
import {
    instanceOfUpdateLoginFlowWithDeviceAuthnMethod,
    UpdateLoginFlowWithDeviceAuthnMethodFromJSON,
    UpdateLoginFlowWithDeviceAuthnMethodFromJSONTyped,
    UpdateLoginFlowWithDeviceAuthnMethodToJSON,
} from './UpdateLoginFlowWithDeviceAuthnMethod';
 ...
 * @export
 */
export type UpdateLoginFlowBody = { method: 'code' } & UpdateLoginFlowWithCodeMethod | { method: 'deviceauthn' } & UpdateLoginFlowWithDeviceAuthnMethod | { method: 'identifier_first' } & UpdateLoginFlowWithIdentifierFirstMethod | { method: 'lookup_secret' } & UpdateLoginFlowWithLookupSecretMethod | { method: 'oidc' } & UpdateLoginFlowWithOidcMethod | { method: 'passkey' } & UpdateLoginFlowWithPasskeyMethod | { method: 'password' } & UpdateLoginFlowWithPasswordMethod | { method: 'saml' } & UpdateLoginFlowWithSamlMethod | { method: 'totp' } & UpdateLoginFlowWithTotpMethod | { method: 'webauthn' } & UpdateLoginFlowWithWebAuthnMethod;
...
export function UpdateLoginFlowBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateLoginFlowBody {
    ...
    switch (json['method']) {
        ...
        case 'deviceauthn':
            return Object.assign({}, UpdateLoginFlowWithDeviceAuthnMethodFromJSONTyped(json, true), { method: 'deviceauthn' } as const);
...
export function UpdateLoginFlowBodyToJSONTyped(value?: UpdateLoginFlowBody | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['method']) {
        ...
        case 'deviceauthn':
            return Object.assign({}, UpdateLoginFlowWithDeviceAuthnMethodToJSON(value), { method: 'deviceauthn' } as const);
        case 'identifier_first':

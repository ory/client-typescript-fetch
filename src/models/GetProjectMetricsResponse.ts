...
export function GetProjectMetricsResponseToJSON(json: any): GetProjectMetricsResponse {
    return GetProjectMetricsResponseToJSONTyped(json, false);
}

export function GetProjectMetricsResponseToJSONTyped(value?: Omit<GetProjectMetricsResponse, 'data'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

...
export function IdentitySchemaPresetToJSON(json: any): IdentitySchemaPreset {
    return IdentitySchemaPresetToJSONTyped(json, false);
}

export function IdentitySchemaPresetToJSONTyped(value?: IdentitySchemaPreset | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

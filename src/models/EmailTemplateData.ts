...
import {
    ...
    EmailTemplateDataBodyToJSONTyped,
...
export function EmailTemplateDataToJSON(json: any): EmailTemplateData {
    return EmailTemplateDataToJSONTyped(json, false);
}

export function EmailTemplateDataToJSONTyped(value?: EmailTemplateData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }

...
export function NormalizedProjectRevisionHookFromJSONTyped(json: any, ignoreDiscriminator: boolean): NormalizedProjectRevisionHook {
    ...
    return {
        ...
        'notify_previous_addresses_config_recipients': json['notify_previous_addresses_config_recipients'] == null ? undefined : json['notify_previous_addresses_config_recipients'],
...
export function NormalizedProjectRevisionHookToJSON(json: any): NormalizedProjectRevisionHook {
    return NormalizedProjectRevisionHookToJSONTyped(json, false);
}

export function NormalizedProjectRevisionHookToJSONTyped(value?: Omit<NormalizedProjectRevisionHook, 'created_at'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'hook': value['hook'],
        'id': value['id'],
        'notify_previous_addresses_config_recipients': value['notify_previous_addresses_config_recipients'],

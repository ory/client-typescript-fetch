...
export interface DeleteTestLoginFlowRequest {
    id: string;
    cookie?: string;
}
...
export class FrontendApi extends runtime.BaseAPI {
    ...
    async createBrowserRecoveryFlowRaw(requestParameters: CreateBrowserRecoveryFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecoveryFlow>> {
        ...
        if (requestParameters['skipSettings'] != null) {
            queryParameters['skip_settings'] = requestParameters['skipSettings'];
        }
     ...
     */
    async deleteTestLoginFlowRaw(requestParameters: DeleteTestLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling deleteTestLoginFlow().'
            );
        }
        ...
        let urlPath = `/self-service/login/test`;
     ...
     * Delete a test OIDC login flow
     */
    async deleteTestLoginFlow(requestParameters: DeleteTestLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteTestLoginFlowRaw(requestParameters, initOverrides);
    }
     ...
     * Change Password URL
     */
    async getWellKnownChangePasswordRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ErrorGeneric>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/.well-known/change-password`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ErrorGenericFromJSON(jsonValue));
    }
     ...
     * Change Password URL
     */
    async getWellKnownChangePassword(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ErrorGeneric> {
        const response = await this.getWellKnownChangePasswordRaw(initOverrides);
        return await response.value();
    }
